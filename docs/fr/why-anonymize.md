...
Par ailleurs, un rapport déclassifié de 2023 de l'`Office of the Director of National Intelligence` reconnaît que les agences de renseignement américaines **achètent régulièrement des données commerciales auprès de data brokers**, notamment des données de localisation et de navigation. La frontière entre écosystème publicitaire et surveillance étatique est, en pratique, poreuse : ce qui est collecté pour vendre de la publicité peut être racheté pour surveiller.
...
- **Avocats** : secret professionnel absolu (article 66-5 de la loi du 31 décembre 1971). Une consultation client envoyée brute à un LLM américain expose l'avocat à une faute déontologique.
- **Médecine** : secret médical (article L.1110-4 du Code de la santé publique en France), HIPAA aux États-Unis. Un dossier patient ne peut pas transiter par un service tiers sans garanties techniques lourdes.
- **Défense et secteurs stratégiques** : régimes spécifiques (classification, `CUI` aux US, `Diffusion Restreinte` en France). Le croisement potentiel entre l'accès légal du gouvernement américain et des intérêts stratégiques (énergie, défense, technologie) rend ce risque non-théorique.
