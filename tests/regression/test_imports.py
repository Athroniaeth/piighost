...
PUBLIC_API: list[tuple[str, str]] = [
    ...
    ("piighost.overlap_resolver", "AnyOverlapResolver"),
    ("piighost.overlap_resolver", "BaseOverlapResolver"),
    ("piighost.overlap_resolver", "ConfidenceOverlapResolver"),
    ...
    ("piighost.guard", "GuardVerdict"),
    ("piighost.guard", "ModerationGuardRail"),
